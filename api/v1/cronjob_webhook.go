...
func (r *CronJob) validateCronJobName() *field.Error {
	if len(r.GetName()) > validationutils.DNS1035LabelMaxLength-11 {
		// -11 because CronJob controller appends the 11 digit Unix timestamp
		// to the job name during creation
